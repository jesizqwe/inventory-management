...
const resources = {
  en: {
    translation: {
      ...
      'inventory.accessControlDescription': 'Grant or revoke write access to this inventory for other users',
      'inventory.noAccessControl': 'No access to control',
      'inventory.statisticsContent': 'Statistics - item counts, field aggregations',
      'inventory.addAccessByEmail': 'Add access by email',
      'inventory.emailPlaceholder': 'user@example.com',
      'inventory.grantAccess': 'Grant Access',
      'inventory.revokeAccess': 'Revoke',
      'inventory.usersWithAccess': 'Users with write access',
      'inventory.noUsersWithAccess': 'No users have been granted access yet',
      'inventory.owner': 'Owner',
      'inventory.hasAccess': 'Write Access',
      'inventory.accessType': 'Access Type',
      'inventory.confirmRemoveAccess': 'Are you sure you want to revoke access for this user?',
  ...
  ru: {
    translation: {
      ...
      'inventory.accessControlDescription': 'Предоставление или отзыв права записи в этот инвентарь для других пользователей',
      ...
      'inventory.addAccessByEmail': 'Добавить доступ по email',
      'inventory.emailPlaceholder': 'user@example.com',
      'inventory.grantAccess': 'Предоставить доступ',
      'inventory.revokeAccess': 'Отозвать',
      'inventory.usersWithAccess': 'Пользователи с правом записи',
      'inventory.noUsersWithAccess': 'Пользователи ещё не получили доступ',
      'inventory.owner': 'Владелец',
      'inventory.hasAccess': 'Право записи',
      'inventory.accessType': 'Тип доступа',
      'inventory.confirmRemoveAccess': 'Вы уверены, что хотите отозвать доступ у этого пользователя?',
